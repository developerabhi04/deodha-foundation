...
const TeamPage = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            longBio: 'श्री बम शंकर, धेवधा विकास समिति के सचिव और विश्वसनीय सहयोगी हैं। वे न केवल समिति के कार्यों में भाग लेते हैं, बल्कि सामाजिक चंदा अभियान, जनजागरूकता, और ग्राम विकास योजनाओं में भी अग्रणी भूमिका निभाते हैं।',
            // quote: '"गांव का विकास तभी संभव है जब हर व्यक्ति अपनी भूमिका निभाए – चाहे वह आर्थिक सहयोग हो या श्रमदान।"',
        }
    ];
