...
const TeamPage = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            role: 'Vice Secretary',
            category: 'leadership',
            image: 'https://res.cloudinary.com/dusalynec/image/upload/v1774883460/Bam_Shankar_Ji_ybzvia.png',
            gradient: 'from-green-600 to-red-600',
            bgColor: 'bg-orange-500',
            location: 'Dheodha, Bihar',
            bio: 'श्री बम शंकर – जनसहयोग और समर्पण का प्रतीक',
            longBio: 'श्री बम शंकर, धेवधा विकास समिति के उप सचिव और विश्वसनीय सहयोगी हैं। वे न केवल समिति के कार्यों में भाग लेते हैं, बल्कि सामाजिक चंदा अभियान, जनजागरूकता, और ग्राम विकास योजनाओं में भी अग्रणी भूमिका निभाते हैं।',
            // quote: '"गांव का विकास तभी संभव है जब हर व्यक्ति अपनी भूमिका निभाए – चाहे वह आर्थिक सहयोग हो या श्रमदान।"',
        }
    ];
