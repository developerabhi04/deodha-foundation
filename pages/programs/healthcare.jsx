// Healthcare program detail page (UI-only - same structure as education)
...
export default function HealthcareProgram() {
  ...
  const programGallery = gallery.filter((img) => img.program === 'healthcare');
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="bg-brand-green text-white p-6 rounded-lg">
                ...
                <p className="text-green-100">Individuals served annually</p>
              </div>
            </motion.div>
