// Education program detail page (UI-only)
...
export default function EducationProgram() {
  ...
  const programGallery = gallery.filter((img) => img.program === 'education');
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="bg-brand-green text-white p-6 rounded-lg">
                ...
                <p className="text-green-100">Students impacted annually</p>
              </div>
            </motion.div>
